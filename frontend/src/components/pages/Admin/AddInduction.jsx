  ...
  return (
    <Layout>
      ...
      <div className="max-w-3xl mx-auto p-6 bg-white rounded-lg shadow-lg">
        <h2 className="text-2xl font-semibold text-gray-700 mb-6">Add Induction</h2>
        ...
        <form onSubmit={handleSubmit} className="grid grid-cols-2 gap-4">
          ...
          <input type="number" name="fresherPresent" placeholder="Freshers Present" value={formData.fresherPresent} onChange={handleChange} required className="border p-2 rounded" />

          <input type="number" name="volunteerPresent" placeholder="Volunteers Present" value={formData.volunteerPresent} onChange={handleChange} required className="border p-2 rounded" />
