      ...
      <div className="container">
        <div className="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
          ...
          <ul className="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
            ...
            >
              <span className="nav-link px-2 link-body-emphasis" style={{ cursor: "pointer" }}>
                Events
              </span>
              ...
              {showDropdown && (
                ...
                >
                  ...
                  <li><Link to="/activities" className="dropdown-item">Activities</Link></li>
                  <li><Link to="/farewell" className="dropdown-item">Farewell</Link></li>
                  <li><Link to="/festival" className="dropdown-item">Festival</Link></li>
                  <li><Link to="/induction" className="dropdown-item">Induction</Link></li>
                </ul>
              )}
            </li>
            ...
            >
              ...
              {showDropdown1 && (
                ...
                >
                  ...
                  <li><Link to="/about" className="dropdown-item">About Icche</Link></li>
                </ul>
              )}
            </li>
          </ul>
